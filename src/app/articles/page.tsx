...
const articleData = [
  ...
  },
  {
    ...
    content: 'Memorandum because I had trouble handling JSON when I was studying Golang.',
    link: 'https://zenn.dev/ryuji_cre8ive/articles/12c452bde74f54'
  },
  {
    title: 'Golang makeについての備忘録',
    content: 'A reminder when I was curious about Golang make and looked into it',
    link: 'https://zenn.dev/ryuji_cre8ive/articles/0d33489819b09d'
  },
  {
    title: 'もうfatal: could not create work tree dir ‘zzzzzz’が出ても怖くないもん！！！',
  ...
  },
  {
    ...
    content: 'A reminder that I looked into the problem when I couldnt jump definitions in VScode',
    link: 'https://zenn.dev/ryuji_cre8ive/articles/0e0ba629341cc8'
  },
  {
    title: 'Next * urql * code-genでフロント開発してみた際の備忘録',
    content: 'Memorandum on front-end development with Next.js * urql * code-gen',
  ...
  },
  {
    ...
    content: 'The story of how I changed to zsh and typed a strange command and the path didnt go through.',
  ...
  },
  {
    ...
    content: 'How to deal with "Unknown column `xxx` in `where clause`" in MySQL',
      ...
      <div className="grid md:grid-cols-2 gap-4 justify-items-center text-center mt-4">
        {
          articleData.map((data) => (
            <ArticleCard key={data.title} title={data.title} content={data.content} link={data.link} />
          ))
        }
      </div>
    </>
